...
is_male_cols = tf.feature_column.categorical_column_with_vocabulary_list("is_male", ["True", "False", "null"])
plurality_cols = tf.feature_column.categorical_column_with_vocabulary_list("plurality", ["1", "2", "3","4","5"])
...
def train_and_evaluate(output_dir):
  ...
  #1: Create estimator
  estimator = tf.estimator.DNNLinearCombinedRegressor(model_dir=output_dir, linear_feature_columns=wide_cols, dnn_feature_columns=deep_cols, dnn_hidden_units=[100, 50])
